...
public class NicehashPascal implements Serializable
{
    ...
    private final static long serialVersionUID = -5988253794124417634L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NicehashPascal) == false) {
            return false;
        }
        NicehashPascal rhs = ((NicehashPascal) other);
