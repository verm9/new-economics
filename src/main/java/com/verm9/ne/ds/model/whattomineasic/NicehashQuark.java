...
public class NicehashQuark implements Serializable
{
    ...
    private final static long serialVersionUID = 657248587540717870L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NicehashQuark) == false) {
            return false;
        }
        NicehashQuark rhs = ((NicehashQuark) other);
