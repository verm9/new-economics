...
public class Karbowanec implements Serializable
{
    ...
    private final static long serialVersionUID = 1134700053013464030L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Karbowanec) == false) {
            return false;
        }
        Karbowanec rhs = ((Karbowanec) other);
