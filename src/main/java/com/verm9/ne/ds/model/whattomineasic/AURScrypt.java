...
public class AURScrypt implements Serializable
{
    ...
    private final static long serialVersionUID = -401550193316496194L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AURScrypt) == false) {
            return false;
        }
        AURScrypt rhs = ((AURScrypt) other);
