...
public class MyriadGroestl implements Serializable
{
    ...
    private final static long serialVersionUID = 1975480979104944207L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MyriadGroestl) == false) {
            return false;
        }
        MyriadGroestl rhs = ((MyriadGroestl) other);
