...
public class Peercoin implements Serializable
{
    ...
    private final static long serialVersionUID = 4243905150110016801L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Peercoin) == false) {
            return false;
        }
        Peercoin rhs = ((Peercoin) other);
