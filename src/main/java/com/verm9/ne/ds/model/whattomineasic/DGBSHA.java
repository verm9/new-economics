...
public class DGBSHA implements Serializable
{
    ...
    private final static long serialVersionUID = -6197327461325976053L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DGBSHA) == false) {
            return false;
        }
        DGBSHA rhs = ((DGBSHA) other);
