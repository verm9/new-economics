...
public class Geocoin implements Serializable
{
    ...
    private final static long serialVersionUID = 3478840201602670653L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Geocoin) == false) {
            return false;
        }
        Geocoin rhs = ((Geocoin) other);
