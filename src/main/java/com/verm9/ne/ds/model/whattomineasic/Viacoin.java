...
public class Viacoin implements Serializable
{
    ...
    private final static long serialVersionUID = -133997581889287391L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Viacoin) == false) {
            return false;
        }
        Viacoin rhs = ((Viacoin) other);
