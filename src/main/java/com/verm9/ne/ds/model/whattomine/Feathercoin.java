...
public class Feathercoin implements Serializable
{
    ...
    private final static long serialVersionUID = 4635521639654884873L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Feathercoin) == false) {
            return false;
        }
        Feathercoin rhs = ((Feathercoin) other);
