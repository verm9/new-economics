...
public class Dogecoin implements Serializable
{
    ...
    private final static long serialVersionUID = -2472946379055572404L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Dogecoin) == false) {
            return false;
        }
        Dogecoin rhs = ((Dogecoin) other);
