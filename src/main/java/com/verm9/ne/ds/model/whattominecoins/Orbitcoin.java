...
public class Orbitcoin implements Serializable
{
    ...
    private final static long serialVersionUID = 4627766372780366172L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Orbitcoin) == false) {
            return false;
        }
        Orbitcoin rhs = ((Orbitcoin) other);
