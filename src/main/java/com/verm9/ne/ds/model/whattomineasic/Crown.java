...
public class Crown implements Serializable
{
    ...
    private final static long serialVersionUID = -4153704443813042134L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Crown) == false) {
            return false;
        }
        Crown rhs = ((Crown) other);
