...
public class DGCX11 implements Serializable
{
    ...
    private final static long serialVersionUID = -7368940060073905912L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DGCX11) == false) {
            return false;
        }
        DGCX11 rhs = ((DGCX11) other);
