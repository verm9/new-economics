...
public class Monero implements Serializable
{
    ...
    private final static long serialVersionUID = 4544734648841902471L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Monero) == false) {
            return false;
        }
        Monero rhs = ((Monero) other);
