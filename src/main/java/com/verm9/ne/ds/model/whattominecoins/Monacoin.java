...
public class Monacoin implements Serializable
{
    ...
    private final static long serialVersionUID = -5294034127017034666L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Monacoin) == false) {
            return false;
        }
        Monacoin rhs = ((Monacoin) other);
