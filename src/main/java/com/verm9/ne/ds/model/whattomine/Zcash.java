...
public class Zcash implements Serializable
{
    ...
    private final static long serialVersionUID = 7956646149287294007L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Zcash) == false) {
            return false;
        }
        Zcash rhs = ((Zcash) other);
