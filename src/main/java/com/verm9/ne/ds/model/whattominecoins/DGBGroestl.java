...
public class DGBGroestl implements Serializable
{
    ...
    private final static long serialVersionUID = 189908560253949022L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DGBGroestl) == false) {
            return false;
        }
        DGBGroestl rhs = ((DGBGroestl) other);
