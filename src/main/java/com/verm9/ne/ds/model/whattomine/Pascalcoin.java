...
public class Pascalcoin implements Serializable
{
    ...
    private final static long serialVersionUID = 7001492501808436330L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Pascalcoin) == false) {
            return false;
        }
        Pascalcoin rhs = ((Pascalcoin) other);
