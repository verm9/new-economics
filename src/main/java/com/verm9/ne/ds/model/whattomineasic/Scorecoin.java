...
public class Scorecoin implements Serializable
{
    ...
    private final static long serialVersionUID = 2903946820197744001L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Scorecoin) == false) {
            return false;
        }
        Scorecoin rhs = ((Scorecoin) other);
