...
public class Decred implements Serializable
{
    ...
    private final static long serialVersionUID = -5731934938980085968L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Decred) == false) {
            return false;
        }
        Decred rhs = ((Decred) other);
