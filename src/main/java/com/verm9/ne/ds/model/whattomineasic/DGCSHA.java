...
public class DGCSHA implements Serializable
{
    ...
    private final static long serialVersionUID = -8067577845153148131L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DGCSHA) == false) {
            return false;
        }
        DGCSHA rhs = ((DGCSHA) other);
