...
public class DGCScrypt implements Serializable
{
    ...
    private final static long serialVersionUID = 9205453644224219494L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DGCScrypt) == false) {
            return false;
        }
        DGCScrypt rhs = ((DGCScrypt) other);
