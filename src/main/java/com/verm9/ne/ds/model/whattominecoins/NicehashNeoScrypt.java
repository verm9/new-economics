...
public class NicehashNeoScrypt implements Serializable
{
    ...
    private final static long serialVersionUID = 3671892906548973679L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NicehashNeoScrypt) == false) {
            return false;
        }
        NicehashNeoScrypt rhs = ((NicehashNeoScrypt) other);
