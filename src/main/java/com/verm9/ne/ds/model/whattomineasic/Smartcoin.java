...
public class Smartcoin implements Serializable
{
    ...
    private final static long serialVersionUID = 5930796843053100001L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Smartcoin) == false) {
            return false;
        }
        Smartcoin rhs = ((Smartcoin) other);
