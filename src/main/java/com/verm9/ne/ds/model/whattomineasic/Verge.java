...
public class Verge implements Serializable
{
    ...
    private final static long serialVersionUID = -9016902154948603386L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Verge) == false) {
            return false;
        }
        Verge rhs = ((Verge) other);
