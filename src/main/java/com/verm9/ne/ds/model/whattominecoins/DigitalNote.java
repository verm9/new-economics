...
public class DigitalNote implements Serializable
{
    ...
    private final static long serialVersionUID = -1477762271531714808L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DigitalNote) == false) {
            return false;
        }
        DigitalNote rhs = ((DigitalNote) other);
