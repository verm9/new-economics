...
public class DeutscheEMark implements Serializable
{
    ...
    private final static long serialVersionUID = -127703412512086540L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DeutscheEMark) == false) {
            return false;
        }
        DeutscheEMark rhs = ((DeutscheEMark) other);
