...
public class Startcoin implements Serializable
{
    ...
    private final static long serialVersionUID = 2198716520592581593L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Startcoin) == false) {
            return false;
        }
        Startcoin rhs = ((Startcoin) other);
