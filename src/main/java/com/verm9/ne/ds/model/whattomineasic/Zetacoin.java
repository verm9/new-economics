...
public class Zetacoin implements Serializable
{
    ...
    private final static long serialVersionUID = 2038504521403012125L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Zetacoin) == false) {
            return false;
        }
        Zetacoin rhs = ((Zetacoin) other);
