...
public class EthereumClassic implements Serializable
{
    ...
    private final static long serialVersionUID = -2071619144544563834L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EthereumClassic) == false) {
            return false;
        }
        EthereumClassic rhs = ((EthereumClassic) other);
