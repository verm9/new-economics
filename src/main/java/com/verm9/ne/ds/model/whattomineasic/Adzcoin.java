...
public class Adzcoin implements Serializable
{
    ...
    private final static long serialVersionUID = 8941263934033035248L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Adzcoin) == false) {
            return false;
        }
        Adzcoin rhs = ((Adzcoin) other);
