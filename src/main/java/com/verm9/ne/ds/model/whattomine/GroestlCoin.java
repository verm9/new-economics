...
public class GroestlCoin implements Serializable
{
    ...
    private final static long serialVersionUID = -8138724543394892301L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GroestlCoin) == false) {
            return false;
        }
        GroestlCoin rhs = ((GroestlCoin) other);
