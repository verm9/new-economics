...
public class NicehashScrypt implements Serializable
{
    ...
    private final static long serialVersionUID = 8987345699601368055L;
    ...
    @JsonProperty("block_reward24")
    public Integer getBlockReward24() {
        return blockReward24;
    }

    @JsonProperty("block_reward24")
    public void setBlockReward24(Integer blockReward24) {
    ...
    @JsonProperty("difficulty24")
    public Integer getDifficulty24() {
        return difficulty24;
    }

    @JsonProperty("difficulty24")
    public void setDifficulty24(Integer difficulty24) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NicehashScrypt) == false) {
            return false;
        }
        NicehashScrypt rhs = ((NicehashScrypt) other);
