...
public class Vertcoin implements Serializable
{
    ...
    private final static long serialVersionUID = -7761216088894903859L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Vertcoin) == false) {
            return false;
        }
        Vertcoin rhs = ((Vertcoin) other);
