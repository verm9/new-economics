...
public class Zdash implements Serializable
{
    ...
    private final static long serialVersionUID = 2939885074005316435L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Zdash) == false) {
            return false;
        }
        Zdash rhs = ((Zdash) other);
