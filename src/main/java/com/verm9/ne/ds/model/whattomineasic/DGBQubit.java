...
public class DGBQubit implements Serializable
{
    ...
    private final static long serialVersionUID = -372349720893878657L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DGBQubit) == false) {
            return false;
        }
        DGBQubit rhs = ((DGBQubit) other);
