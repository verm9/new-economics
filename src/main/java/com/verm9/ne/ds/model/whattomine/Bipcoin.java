...
public class Bipcoin implements Serializable
{
    ...
    private final static long serialVersionUID = 5312866687083801398L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Bipcoin) == false) {
            return false;
        }
        Bipcoin rhs = ((Bipcoin) other);
