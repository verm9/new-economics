...
public class DNotes implements Serializable
{
    ...
    private final static long serialVersionUID = 6592844430001058271L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DNotes) == false) {
            return false;
        }
        DNotes rhs = ((DNotes) other);
