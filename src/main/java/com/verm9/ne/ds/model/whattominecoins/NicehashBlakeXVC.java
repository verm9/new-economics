...
public class NicehashBlakeXVC implements Serializable
{
    ...
    private final static long serialVersionUID = 2678841915330867998L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NicehashBlakeXVC) == false) {
            return false;
        }
        NicehashBlakeXVC rhs = ((NicehashBlakeXVC) other);
