...
public class Belacoin implements Serializable
{
    ...
    private final static long serialVersionUID = -3144785701050304317L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Belacoin) == false) {
            return false;
        }
        Belacoin rhs = ((Belacoin) other);
