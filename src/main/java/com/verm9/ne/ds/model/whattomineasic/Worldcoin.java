...
public class Worldcoin implements Serializable
{
    ...
    private final static long serialVersionUID = 1286436669622993598L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Worldcoin) == false) {
            return false;
        }
        Worldcoin rhs = ((Worldcoin) other);
