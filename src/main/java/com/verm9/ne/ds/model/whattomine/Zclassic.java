...
public class Zclassic implements Serializable
{
    ...
    private final static long serialVersionUID = -7281878830560085039L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Zclassic) == false) {
            return false;
        }
        Zclassic rhs = ((Zclassic) other);
