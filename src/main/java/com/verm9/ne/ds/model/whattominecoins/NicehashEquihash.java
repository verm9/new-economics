...
public class NicehashEquihash implements Serializable
{
    ...
    private final static long serialVersionUID = 6297815102842714561L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NicehashEquihash) == false) {
            return false;
        }
        NicehashEquihash rhs = ((NicehashEquihash) other);
