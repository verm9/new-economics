...
public class Mazacoin implements Serializable
{
    ...
    private final static long serialVersionUID = -5108382472558783027L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Mazacoin) == false) {
            return false;
        }
        Mazacoin rhs = ((Mazacoin) other);
