...
public class NicehashCryptoNight implements Serializable
{
    ...
    private final static long serialVersionUID = -5646014359990483578L;
    ...
    @JsonProperty("block_reward24")
    public Long getBlockReward24() {
        return blockReward24;
    }

    @JsonProperty("block_reward24")
    public void setBlockReward24(Long blockReward24) {
    ...
    @JsonProperty("difficulty24")
    public Long getDifficulty24() {
        return difficulty24;
    }

    @JsonProperty("difficulty24")
    public void setDifficulty24(Long difficulty24) {
    ...
    @JsonProperty("profitability24")
    public Long getProfitability24() {
        return profitability24;
    }

    @JsonProperty("profitability24")
    public void setProfitability24(Long profitability24) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NicehashCryptoNight) == false) {
            return false;
        }
        NicehashCryptoNight rhs = ((NicehashCryptoNight) other);
