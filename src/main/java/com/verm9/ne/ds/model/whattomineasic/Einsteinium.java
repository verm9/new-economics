...
public class Einsteinium implements Serializable
{
    ...
    private final static long serialVersionUID = 4873991618383575567L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Einsteinium) == false) {
            return false;
        }
        Einsteinium rhs = ((Einsteinium) other);
