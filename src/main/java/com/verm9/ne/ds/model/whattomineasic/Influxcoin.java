...
public class Influxcoin implements Serializable
{
    ...
    private final static long serialVersionUID = 248882767226250624L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Influxcoin) == false) {
            return false;
        }
        Influxcoin rhs = ((Influxcoin) other);
