...
public class NicehashEthash implements Serializable
{
    ...
    private final static long serialVersionUID = -4307812106506195917L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NicehashEthash) == false) {
            return false;
        }
        NicehashEthash rhs = ((NicehashEthash) other);
