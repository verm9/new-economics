...
public class NicehashX11 implements Serializable
{
    ...
    private final static long serialVersionUID = -6397319922124032591L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NicehashX11) == false) {
            return false;
        }
        NicehashX11 rhs = ((NicehashX11) other);
