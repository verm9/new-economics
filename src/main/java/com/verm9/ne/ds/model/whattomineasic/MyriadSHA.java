...
public class MyriadSHA implements Serializable
{
    ...
    private final static long serialVersionUID = 5482968638558812585L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MyriadSHA) == false) {
            return false;
        }
        MyriadSHA rhs = ((MyriadSHA) other);
