...
public class Novacoin implements Serializable
{
    ...
    private final static long serialVersionUID = 7948884185295596565L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Novacoin) == false) {
            return false;
        }
        Novacoin rhs = ((Novacoin) other);
