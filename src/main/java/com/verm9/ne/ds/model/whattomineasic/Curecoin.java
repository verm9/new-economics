...
public class Curecoin implements Serializable
{
    ...
    private final static long serialVersionUID = -1363060861475138950L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Curecoin) == false) {
            return false;
        }
        Curecoin rhs = ((Curecoin) other);
