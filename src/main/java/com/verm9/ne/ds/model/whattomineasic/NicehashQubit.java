...
public class NicehashQubit implements Serializable
{
    ...
    private final static long serialVersionUID = 7038894502014778187L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NicehashQubit) == false) {
            return false;
        }
        NicehashQubit rhs = ((NicehashQubit) other);
