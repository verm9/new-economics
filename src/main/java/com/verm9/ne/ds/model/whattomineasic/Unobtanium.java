...
public class Unobtanium implements Serializable
{
    ...
    private final static long serialVersionUID = 2041414661170596983L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Unobtanium) == false) {
            return false;
        }
        Unobtanium rhs = ((Unobtanium) other);
