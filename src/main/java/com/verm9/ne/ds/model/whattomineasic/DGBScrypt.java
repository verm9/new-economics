...
public class DGBScrypt implements Serializable
{
    ...
    private final static long serialVersionUID = 7009254365730500929L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DGBScrypt) == false) {
            return false;
        }
        DGBScrypt rhs = ((DGBScrypt) other);
