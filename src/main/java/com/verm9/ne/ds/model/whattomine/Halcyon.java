...
public class Halcyon implements Serializable
{
    ...
    private final static long serialVersionUID = -1372952416414561542L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Halcyon) == false) {
            return false;
        }
        Halcyon rhs = ((Halcyon) other);
