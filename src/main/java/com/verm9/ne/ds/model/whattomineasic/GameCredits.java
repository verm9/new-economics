...
public class GameCredits implements Serializable
{
    ...
    private final static long serialVersionUID = 1979685657417748149L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GameCredits) == false) {
            return false;
        }
        GameCredits rhs = ((GameCredits) other);
