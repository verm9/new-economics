...
public class Sibcoin implements Serializable
{
    ...
    private final static long serialVersionUID = -4761840010115044996L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sibcoin) == false) {
            return false;
        }
        Sibcoin rhs = ((Sibcoin) other);
