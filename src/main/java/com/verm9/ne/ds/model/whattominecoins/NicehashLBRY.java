...
public class NicehashLBRY implements Serializable
{
    ...
    private final static long serialVersionUID = 1316990617833414526L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NicehashLBRY) == false) {
            return false;
        }
        NicehashLBRY rhs = ((NicehashLBRY) other);
