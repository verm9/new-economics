...
public class NicehashSHA implements Serializable
{
    ...
    private final static long serialVersionUID = -3420038304657136829L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NicehashSHA) == false) {
            return false;
        }
        NicehashSHA rhs = ((NicehashSHA) other);
