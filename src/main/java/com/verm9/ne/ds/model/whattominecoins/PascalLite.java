...
public class PascalLite implements Serializable
{
    ...
    private final static long serialVersionUID = 1690359198733487318L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PascalLite) == false) {
            return false;
        }
        PascalLite rhs = ((PascalLite) other);
